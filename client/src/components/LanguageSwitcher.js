...
import { gold, goldLight, goldDark, darkBg } from '../theme';
      ...
      <Menu
        ...
        PaperProps={{
          ...
          sx: {
            ...
            boxShadow: `0 16px 48px ${alpha('#000', 0.7)}, 0 0 30px ${alpha(gold, 0.06)}`,
            mt: 1,
            minWidth: 180,
            overflow: 'hidden',
            '&::before': {
          ...
          <MenuItem
            ...
            sx={{
              ...
              '&.Mui-selected': {
                ...
                '&:hover': { backgroundColor: alpha(gold, 0.16) },
              },
            }}
          >
            <Typography
              sx={{
                ...
                fontSize: '0.82rem',
                fontWeight: 300,
                color: currentLang === code ? gold : alpha(goldLight, 0.7),
              }}
            >
              {native}
            </Typography>
